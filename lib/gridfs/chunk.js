...
//collection.replaceOne({'_id':self.objectId}, mongoObject, writeOptions, function(err, collection) {
        collection.replaceOne({storage:mongoObject.storage,files_id:mongoObject.files_id,n:mongoObject.n}, mongoObject, writeOptions, function(err, collection) {
          callback(err, self);
        });
      });
    } else {
...
Chunk.prototype.buildMongoObject = function(callback) {
  var mongoObject = {
    ...
    'n': this.chunkNumber,
    'data': this.data};
  if(this.file.options.storage){
    mongoObject["storage"] = this.file.options.storage;
  }
